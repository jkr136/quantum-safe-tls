...
//variable declarations for OpenSSL structures
...
int done = 0;
//signal handler (triggered on pressing Ctrl+C in terminal)
//instead of killing the program rudely
...
//utility function for extracting Common Name(CN) from an X.509 certificate
...
//custom certificate verification callback function used by OpenSSL,
//when validating peer's certificate during a TLS handshake
